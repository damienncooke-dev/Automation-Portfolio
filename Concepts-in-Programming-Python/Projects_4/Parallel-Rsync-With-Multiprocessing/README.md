# Parallel Rsync With Multiprocessing (**Documentation in Progress**)

## Executive Summary
A log file parser script is created as a companion script to a new monitoring program that outputs to a log file. The log parser script will allow the user to specify the error pattern to search for and review later in an output file.

## System Architecture and Workflow
1. **Data Input** -Read an input log file containing status messages from a monitoring program.
